...
net.Receive("ASM:Net:OpenMenu", function() 
    ...
    if IsValid( ASSuiteFrame ) then ASSuiteFrame:Remove() end
        ...
        ASSuiteFrame.Paint = function( s, w, h )
            ...
            draw.SimpleText( "Advanced Staff Mod | "..ASM.Config.CommunityName, "ASFont40", RespX( 259 ), RespY( 0 ), Color(255,255,255,255), TEXT_ALIGN_LEFT, TEXT_ALIGN_TOP )
    ...
    ASWarnBtn.DoClick = function()
        ...
        if IsValid( ASSuiteFrame ) then ASSuiteFrame:Remove() end
            ...
            LocalPlayer():ConCommand( "say "..ASM.Config.WarnCommand )
    end
    ...
    ASLogBtn.DoClick = function()
        ...
        if IsValid( ASSuiteFrame ) then ASSuiteFrame:Remove() end
            ...
            LocalPlayer():ConCommand( "say "..ASM.Config.LogsCommand )
    end
